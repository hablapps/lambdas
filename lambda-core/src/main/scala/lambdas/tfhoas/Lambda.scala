...
object Lambda extends LPI_Lambda {
  ...
  implicit def _TDBLambda[Type[_]: ArrowType: safecast.Cast, P[_, _]: tfdb.Lambda[Type, ?[_, _]]]
    : Lambda[Type, semantics.TDB[Type, P, ?]] =
    new semantics.TDB.TDB_Hoas[Type, P]
}
